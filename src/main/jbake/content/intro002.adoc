...
* link:#install-the-netbeans-ide[Install the Apache NetBeans IDE]
...
[[GCRNU]][[install-the-netbeans-ide]]

Install the Apache NetBeans IDE
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

To get NetBeans IDE, go to `https://netbeans.apache.org/` and
download the latest distribution. Install this distribution.
